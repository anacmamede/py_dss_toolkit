    ...
    def __check_phases_connections(self):
            ...
            if end_elem not in elements_checked:
                ...
                while self._dss.circuit.parent_pd_element:
                    ...
                    if parent_elem_name not in elements_checked:
                        if "Transformer" in parent_elem_name or "transformer" in parent_elem_name: # Check if there is a transformer bank
                            ...
                            for element in elements: # Association of transformers of a bank
                                if element.split(".")[0] == "Transformer" or element.split(".")[0] == "transformer":
        ...
        for elem_pc in elements_pc:
            if elem_pc not in elements_checked:
                ...
                elem_bus = self._dss.cktelement.bus_names[0].split(".")[0]
                elem_nodes = self._dss.cktelement.bus_names[0].split(".")[1:]
                ...
                if elem_name not in elements_checked:
                    ...
                    for element in elements:  # Association with the pc elements
                        ...
                        elem_nodes = self.__add_default_nodes(elem_nodes)[0:]
                        parent_elem_nodes1 = self.__add_default_nodes(transformer_bus1_node1)[0:]
                        parent_elem_nodes2 = self.__add_default_nodes(transformer_bus2_node2)[0:]

                    elem_pc_bus.append(elem_bus)
                    elem_pc_nodes.append(elem_nodes)
